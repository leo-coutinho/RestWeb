      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <button type="button" value="Quick" id="user3" class="btn btn-primary btn-lg btn-block">Sign in with Leo</button>
            <button type="button" value="Blox" id="user4" class="btn btn-success btn-lg btn-block">Sign in with Neil</button>
            <div class="progress">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <button id="add-dialog" type="button" value="Confirm" id="" class="btn btn-success btn-lg btn-block" onclick="createNewDialog()">Createss dialog</button>
            <div class="progress">
              <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%">
              </div>
            </div>
