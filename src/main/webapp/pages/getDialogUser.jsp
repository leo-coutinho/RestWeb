...
<head lang="en">
    ...
    <title>VouchFor Get Users</title>
...
<%--<div class="row">--%>
    ...
    <%--<form class="form-horizontal" role="form">--%>
        <%--<div class="form-group">--%>
            ...
            <%--<div class="col-sm-6">--%>
                <%--<input type="text" value="${usr_sgn_n_lgn}" class="form-control" id="usr_sgn_n_lgn" placeholder="Enter login">--%>
            <%--</div>--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
            <%--<td> ${usr_sgn_n_pwd}</td>--%>
            ...
            <%--<div class="col-sm-6">--%>
                <%--<input type="password" value="${usr_sgn_n_pwd}" class="form-control" id="usr_sgn_n_pwd" placeholder="Enter password">--%>
            <%--</div>--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
            <%--<div class="col-sm-offset-2 col-sm-10">--%>
...
<div class="row" hidden="true">
    ...
    <form class="form-horizontal" role="form">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select class="form-control" id="sel_filter_for_users">
                    ...
                    <%--<option value="3" selected="selected">by login</option>--%>
                    <option value="4"selected="selected">by fullname</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" value= "${userLogin}"class="form-control" id="usrs_get_by_filter" placeholder="Enter a value for filter:">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">

                <button type="button" class="btn btn-primary" id="dialogClick" data-toggle="modal" data-target="#progressModal">Try</button>
            </div>
        </div>
...
<%--<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>--%>
<%--<script src="https://cdn.digits.com/1/sdk.js" id="digits-sdk" async></script><!-- TWITTER_DIGITS SDK -->--%>
<%--<script src="/resources/js/quickblox.min.js"></script>--%>
<%--<!--<script src="../../quickblox.min.js"></script>-->--%>
