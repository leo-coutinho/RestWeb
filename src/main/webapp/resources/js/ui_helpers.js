...
function buildMessageHTML(messageText, messageSenderId, messageDateSent, attachmentFileId, messageId, status){
  ...
  var delivered = '<img class="icon-small" src="/resources/images/delivered.jpg" alt="" id="delivered_'+messageId+'">';
  var read = '<img class="icon-small" src="/resources/images/read.jpg" alt="" id="read_'+messageId+'">';
