...
function getDialogIcon (dialogType) {
  var groupPhoto = '<img src="/resources/images/ava-group.svg" width="30" height="30" class="round">';
  var privatPhoto  = '<img src="/resources/images/ava-single.svg" width="30" height="30" class="round">';
...
function setupUsersScrollHandler(){
  // alert("Users Scroll Handler");
  // uploading User scroll event
...
// create new dialog
function createUserDialog(userId,userName) {
  var usersIds = [];
  var usersNames = [];
   alert("CreatingUserDialog");
  alert(JSON.stringify(userId));
  ...
  // QB.chat.onMessageListener = onMessage(opponentId,msg);
  var params = {
    type: 3,
...
function createNewDialog() {
  ...
  QB.chat.dialog.create(params, function(err, createdDialog) {
    ...
    if (err) {
      ...
      console.log("Dialog " + createdDialog._id + " created with User: " + dialogOccupants);
